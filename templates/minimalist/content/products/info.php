...
<h3 style="margin-top: 0px; margin-bottom: 5px;background-color: rgb(246, 246, 246);"><?php echo $osC_Template->getPageTitle(); ?></h3>
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <table id="productInfo" border="0" cellspacing="0" cellpadding="2" style="float: right; width: 400px">
...
<!--      </tr>-->
      ...
      <tr>
        ...
        <td class="label" id="productInfoAvailable"><?php echo ($osC_Product->getQuantity() > 0) ? $osC_Language->get('in_stock') : $osC_Language->get('out_of_stock'); ?></td>
      </tr>
  ...
  ?>
      <tr>
        ...
        <td class="label" id="productInfoQty"><?php echo $osC_Product->getQuantity() . ' ' . $osC_Product->getUnitClass(); ?></td>
      </tr>
  <?php
    }
  ...
  ?>
      <tr>      
        ...
        <td class="label"><?php echo osc_draw_input_field('gift_certificate_amount', $osC_Product->getOpenAmountMinValue(), 'size="18"'); ?></td>
      </tr>
  <?php
    }
  ?>
      <tr>      
        ...
        <td class="label"><?php echo osc_draw_input_field('senders_name', null, 'size="18"'); ?></td>
      </tr>
  <?php
...
<!--      <tr>-->
<!--        <td colspan="2" align="left" id = "shoppingAction">-->
<!--          --><?php
