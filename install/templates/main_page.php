...
<div id="wapper">
  <div id="pageHeader">
    <div style="float: right; padding-top: 40px; padding-right: 15px; color: #000000; font-weight: bold;"><a href="http://www.mefobemarket.com" target="_blank"><?php echo $osC_Language->get('head_tomatocart_support_title'); ?></a> &nbsp;|&nbsp;<a href="http://www.mefobemarket.com/index.php/community/forum" target="_blank"><?php echo $osC_Language->get('head_tomatocart_support_forum_title'); ?></a> &nbsp;|&nbsp; <a href="http://www.oscommerce.com" target="_blank"><?php echo $osC_Language->get('head_oscommerce_support_title'); ?></a></div>
