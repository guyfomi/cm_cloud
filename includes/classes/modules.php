...
class osC_Modules
{
    ...
    function osC_Modules($group)
    {
        ...
        if(1 == 2){
            ...
            if (isset($_GET['cPath'])) {
                $Qspecific->bindRaw(':content_page', '"*","' . $osC_Template->getGroup() . '/cPath=' . $_GET['cPath'] . '"');
            }
            else
            {
                $Qspecific->bindRaw(':content_page', '"*","' . $osC_Template->getGroup() . '/cPath=' . $_GET['cPath'] . '", "' . $osC_Template->getGroup() . '/*", "' . $osC_Template->getGroup() . '/' . substr($osC_Template->getPageContentsFilename(), 0, strrpos($osC_Template->getPageContentsFilename(), '.')) . '"');
            }
        ...
        if ($Qspecific->numberOfRows()) {
          ...
          $_data = array();
                ...
                if (isset($_GET['cPath'])) {
                    $Qmodules->bindRaw(':content_page', '"*","' . $osC_Template->getGroup() . '/cPath=' . $_GET['cPath'] . '"');
                }
                else
                {
                    $Qmodules->bindRaw(':content_page', '"*","' . $osC_Template->getGroup() . '/cPath=' . $_GET['cPath'] . '", "' . $osC_Template->getGroup() . '/*", "' . $osC_Template->getGroup() . '/' . substr($osC_Template->getPageContentsFilename(), 0, strrpos($osC_Template->getPageContentsFilename(), '.')) . '"');
                }
