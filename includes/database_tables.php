<?php
  ...
  define('TABLE_LAYOUT', DB_TABLE_PREFIX . 'layout');
  define('TABLE_CATEGORIES_DESCRIPTION', DB_TABLE_PREFIX . 'categories_description');
  define('TABLE_LAYOUT_DESCRIPTION', DB_TABLE_PREFIX . 'layout_description');
  define('TABLE_PLANTS', DB_TABLE_PREFIX . 'plants');
  ...
  define('TABLE_LINES', DB_TABLE_PREFIX . 'lines');
  define('TABLE_COMPONENT', DB_TABLE_PREFIX . 'component');
  define('TABLE_ASSET', DB_TABLE_PREFIX . 'asset');
  define('TABLE_SENSOR', DB_TABLE_PREFIX . 'sensor');
  define('TABLE_PARAMETERS', DB_TABLE_PREFIX . 'parameters');
  define('TABLE_IMPORTS', DB_TABLE_PREFIX . 'imports');
  define('TABLE_EVENTLOG', DB_TABLE_PREFIX . 'eventlog');
