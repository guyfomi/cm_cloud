...
*/
    ...
    class osC_Content_articles_slider_tiny extends osC_Modules
    {
        var $_title,
        $_code = 'articles_slider_tiny',
        $_author_name = 'Mefobe',
...
/* Class constructor */
        ...
        function osC_Content_articles_slider_tiny()
        {
            $this->_title = 'Defilement des articles (Tiny 2)';
        }
        ...
        function initialize()
        {
            ...
            if ($Qarticles->numberOfRows()) {
                ...
                $osC_Template->addStyleSheet('ext/tinyslider2/style.css');
                $osC_Template->addJavascriptFilename('ext/tinyslider2/script.js');

                $pagination = '<ul id="pagination" class="pagination">';

                $this->_content .= '<div id="wrapper"><div id="container"><div class="sliderbutton" id="slideleft" onclick="slideshow.move(-1)"></div><div id="slider"><ul>';
                $i = 1;
                ...
                $this->_content .= '</ul></div><div class="sliderbutton" id="slideright" onclick="slideshow.move(1)"></div>';
