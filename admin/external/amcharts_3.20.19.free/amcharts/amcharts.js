    ...
    d.AxisBase = d.Class({construct: function (a) {
        ...
        handleMouse: function (a, b, c) {
            ...
            a ? d.VML || (a = {x: a.x + this.x, y: a.y + this.y,
                width: a.width, height: a.height}) : a = {x: 0, y: 0, width: 0, height: 0};
            return a
        }, destroy: function () {
            d.remove(this.set);
    ...
    d.ValueAxis = d.Class({inherits: d.AxisBase, construct: function (a) {
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
            ...
            if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(),
                ...
                if (!0 === h)if (w > this.logGridLimit)t = Math.pow(10,
                    g); else if (0 >= t && (t = c + y * g + y / 2, 0 >= t))continue;
                ...
                if (!isNaN(z) && 0 < A && g < r - 1) {
                    ...
                    for (H = 1; H < f; H++) {
                        var Q =
                            this.getCoordinate(t + z * H), Q = new this.axisItemRenderer(this, Q, "", !1, 0, 0, !1, !1, 0, !0);
                        this.pushAxisItem(Q)
                    }
                    this.gridAlpha = K
                }
            ...
            u = {type: "axisChanged", target: this,
                chart: a};
        ...
        for (var e = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E), d = 0; d < c.length; d++) {
            var f =
                a / c[d], g = Math.floor(Math.log(Math.abs(f)) * Math.LOG10E);
        ...
        if (r && ("regular" == b || "100%" == b))for (q = 0; q < k.length; q++)n = k[q], n.stackGraph =
        ...
        if (this.includeGuidesInMinMax && 0 < a)for (b = 0; b < a; b++)c = this.guides[b], c.toValue < this.min && (this.min = c.toValue), c.value < this.min && (this.min = c.value), c.toValue > this.max && (this.max = c.toValue),
        ...
        var c = this.rotate, e = this.reversed, d = this.axisWidth,
            f = this.stepWidth, g = this.min, k = this.minReal;
...
(function () {
    ...
    d.AmChart = d.Class({construct: function (a) {
        ...
        handleMouseDown: function (a) {
            ...
            if (!this.hideCredits) {
                var a = "", b = window.location.hostname.split("."), c;
...
(function () {
    ...
    d.AmGraph = d.Class({construct: function (a) {
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e, -1E3)), b.animate({opacity: 1, translate: e + "," + d}, f, g), c.animate({opacity: 1,
    ...
    d.AmBalloon = d.Class({construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var r = this.horizontalPadding, w = this.verticalPadding, y = this.pointerWidth, x = this.pointerOrientation, u = this.cornerRadius,
...
(function () {
    ...
    d.TrendLine = d.Class({construct: function (a) {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, w = a.finalXValue, y = a.initialValue, x =
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        359.94 < x && (x = 359.94);
        h >= x && (h = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, z = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * g, D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g, K = b + Math.sin((e + h) * u) * k, u = c - Math.cos((e + h) * u) * w, H = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, Q = 0;
        180 < Math.abs(h) && (Q = 1);
        e = a.set();
        var M;
...
(function () {
    var d = window.AmCharts;
    d.Bezier = d.Class({construct: function (a, b, c, e, h, f, g, k, l, m, n) {
        var q, p;
