...
?>
Toc.events.mainPanel = function(config) {
  config = config || {};
  ...
  config.grdCategories = new Toc.events.EventsGrid({owner: config.owner, mainPanel: this});
  ...
  Toc.events.mainPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.events.mainPanel, Ext.Panel, {
