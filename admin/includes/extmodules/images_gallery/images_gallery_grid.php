...
Toc.images_gallery.ImagesGalleryGrid = function(config) {
  ...
  Toc.images_gallery.ImagesGalleryGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.images_gallery.ImagesGalleryGrid, Ext.grid.GridPanel, {
  
  onAdd: function() {
    var dlg = this.owner.createImagesGalleryDialog();
    ...
    dlg.show(null,this.categoriesId);
  },
  ...
  onEdit: function(record) {
    ...
    dlg.show(record.get('image_id'),this.categoriesId);
  },
