...
Toc.eventlog.GroupTreePanel = function(config) {
  config = config || {};
  ...
  Toc.eventlog.GroupTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.eventlog.GroupTreePanel, Ext.tree.TreePanel, {
