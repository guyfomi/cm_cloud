...
Toc.products.ProductsMainPanel = function(config) {
  ...
  config.pnlCategoriesTree = new Toc.CategoriesTreePanel({owner: config.owner, parent: this,showHome : 0,showContentCount : 1,rootTitle : 'Categories',checkPermission : 0});
