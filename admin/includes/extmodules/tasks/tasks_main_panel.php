...
?>
Toc.tasks.mainPanel = function(config) {
  config = config || {};
  ...
  config.grdCategories = new Toc.tasks.TasksGrid({owner: config.owner, mainPanel: this});
  ...
  Toc.tasks.mainPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.tasks.mainPanel, Ext.Panel, {
