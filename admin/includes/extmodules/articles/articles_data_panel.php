...
Toc.articles.DataPanel = function(config) {
  config = config || {};    
  ...
  Toc.articles.DataPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.articles.DataPanel, Ext.Panel, {
      ...
      items: [
        {
          ...
          items: [
            ...
            {xtype:'textarea', fieldLabel: 'Intro', name: 'articles_intro', id: 'articles_intro',maxLength : 500,height:200}
          ]
        },
        {
          border: false,
