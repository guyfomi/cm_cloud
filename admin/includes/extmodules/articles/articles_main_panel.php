...
?>
Toc.articles.mainPanel = function(config) {
  config = config || {};
  ...
  config.grdCategories = new Toc.articles.ArticlesGrid({owner: config.owner, mainPanel: this});
  ...
  Toc.articles.mainPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.articles.mainPanel, Ext.Panel, {
