...
Toc.imports.GroupTreePanel = function(config) {
  config = config || {};
  ...
  Toc.imports.GroupTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.imports.GroupTreePanel, Ext.tree.TreePanel, {
