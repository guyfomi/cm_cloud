...
Toc.information.InformationGrid = function(config) {
  ...
  config.cm = new Ext.grid.ColumnModel([
    config.sm, 
    { id: 'information_content_name', header: '<?php echo $osC_Language->get('table_heading_articles'); ?>', dataIndex: 'content_name', sortable: true},
  ...
  config.autoExpandColumn = 'information_content_name';
