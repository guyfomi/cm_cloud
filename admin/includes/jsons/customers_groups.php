...
*/
  ...
  class toC_Json_Customers_Groups {
    ...
    function listCustomersGroups() {
      ...
      $Qgroups = $osC_Database->query('select c.customers_groups_id, cg.customers_groups_name,  c.customers_groups_discount, c.is_default from :table_customers_groups c, :table_customers_groups_description cg where c.customers_groups_id = cg.customers_groups_id order by cg.customers_groups_name');
